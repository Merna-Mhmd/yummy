...
function closeSide() {
    let boxWidth = $(".side-nav .tab").outerWidth()
...
function inputsValidation() {
    if (nameInputTouched) {
        if (nameValidation()) {
            ...
            nAlert.classList.replace("d-block", "d-none")

        } else {
            let nAlert=document.getElementById("nameAlert");
            nAlert.classList.replace("d-none", "d-block")
    ...
    if (emailInputTouched) {
        ...
        if (emailValidation()) {
            let eAlert=document.getElementById("emailAlert");
            eAlert.classList.replace("d-block", "d-none")
        } else {
            let eAlert=document.getElementById("emailAlert");
            eAlert.classList.replace("d-none", "d-block")
    ...
    if (phoneInputTouched) {
        if (phoneValidation()) {
            let pAlert=document.getElementById("phoneAlert");
            pAlert.classList.replace("d-block", "d-none")
        } else {
            let pAlert=document.getElementById("phoneAlert");
    ...
    if (ageInputTouched) {
        if (ageValidation()) {
            let aAlert=document.getElementById("ageAlert");
            aAlert.classList.replace("d-block", "d-none")
        } else {
            let aAlert=document.getElementById("ageAlert");
            aAlert.classList.replace("d-none", "d-block")
    ...
    if (repasswordInputTouched) {
        if (repasswordValidation()) {
            ...
            let repAlert=document.getElementById("repasswordAlert")
            repAlert.classList.replace("d-block", "d-none")
        } else {
            
            let repAlert=document.getElementById("repasswordAlert")
            repAlert.classList.replace("d-none", "d-block")
